...
class OrdinalLogReg():
    ...
    def loss(self, matrix):
        ...
        proba_added_1 = np.concatenate((proba, np.ones([self.X.shape[0], 1])), axis=1) #add last value
        proba = np.diff(proba_added_1)#differences of i -logitvalues
